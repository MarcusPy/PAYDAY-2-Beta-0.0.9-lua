...
function LootSecuredTriggerUnitElement:_build_panel( panel, panel_sizer )
	...
	include_instant_cash:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = include_instant_cash, value = "include_instant_cash" } )
	...
	report_only:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = report_only, value = "report_only" } )
