...
function SmokeGrenadeElement:_build_panel( panel, panel_sizer )
	...
	ignore_control:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = ignore_control, value = "ignore_control" } )
	...
	effect_type_box:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = effect_type_box, value = "effect_type" } )
