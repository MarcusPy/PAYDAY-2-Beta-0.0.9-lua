...
--[[function TeammateCommentUnitElement:set_category()
...
function TeammateCommentUnitElement:_add_soundbank()
...
function TeammateCommentUnitElement:_build_panel( panel, panel_sizer )
	...
	-- comment:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "_add_soundbank" ), nil )
	...
	close_to_element:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = close_to_element, value = "close_to_element" } )
...
--[[function TeammateCommentUnitElement:add_to_mission_package()
	managers.editor:add_to_sound_package{ category = "soundbanks", name = managers.sound_environment:scene_soundbank( self._hed.sound_event ) }
end]]
