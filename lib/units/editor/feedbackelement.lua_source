...
--[[function FeedbackUnitElement:test_element()
end

function FeedbackUnitElement:stop_test_element()
end]]
...
function FeedbackUnitElement:update_selected()
	...
	brush:set_color( Color(0.15, 0.0, 1.0, 0.0) )
	pen:set( Color(0.15, 0.0, 1.0, 0.0) )
...
function FeedbackUnitElement:_build_panel( panel, panel_sizer )
	...
	--[[local effect_params = {
		...
		panel 				= panel,
		sizer 				= panel_sizer,
		options				= managers.feedback:get_effect_names(),
		value 				= self._hed.effect,
		tooltip 			= "Select a effect from the combobox",
		name_proportions 	= 1,
		ctrlr_proportions 	= 2,
		sizer_proportions	= 1,
		sorted				= true
	...
	use_camera_shake:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = use_camera_shake, value = "use_camera_shake" } )
	...
	camera_shake_amplitude:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_amplitude, value = "camera_shake_amplitude" } )
	camera_shake_amplitude:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_amplitude, value = "camera_shake_amplitude" } )
	...
	camera_shake_attack:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_attack, value = "camera_shake_attack" } )
	camera_shake_attack:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_attack, value = "camera_shake_attack" } )
	
	-- camera_shake_sustain
	...
	camera_shake_sustain:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_sustain, value = "camera_shake_sustain" } )
	camera_shake_sustain:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_sustain, value = "camera_shake_sustain" } )
	...
	camera_shake_decay:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_decay, value = "camera_shake_decay" } )
	camera_shake_decay:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_decay, value = "camera_shake_decay" } )
...
-- Rumble
	...
	rumble_peak:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = rumble_peak, value = "rumble_peak" } )
	rumble_peak:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = rumble_peak, value = "rumble_peak" } )
	...
	rumble_attack:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = rumble_attack, value = "rumble_attack" } )
	rumble_attack:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = rumble_attack, value = "rumble_attack" } )
	...
	rumble_sustain:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = rumble_sustain, value = "rumble_sustain" } )
	rumble_sustain:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = rumble_sustain, value = "rumble_sustain" } )
	...
	rumble_release:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = rumble_release, value = "rumble_release" } )
	rumble_release:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = rumble_release, value = "rumble_release" } )
...
-- Rumble
	...
	above_camera_effect:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = above_camera_effect, value = "above_camera_effect" } )
	...
	above_camera_effect_distance:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = above_camera_effect_distance, value = "above_camera_effect_distance" } )
	above_camera_effect_distance:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = above_camera_effect_distance, value = "above_camera_effect_distance" } )
...
function FeedbackUnitElement:add_to_mission_package()
	if self._hed.effect and self._hed.above_camera_effect ~= "none" then
		managers.editor:add_to_world_package( { category = "effects", name = self._hed.above_camera_effect, continent = self._unit:unit_data().continent } )
	end
end
