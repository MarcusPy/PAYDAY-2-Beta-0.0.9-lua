...
function ConsoleCommandUnitElement:_build_panel( panel, panel_sizer )
	...
	text:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = text, value = "cmd" } )
	text:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = text, value = "cmd" } )
