...
function JobStageAlternativeUnitElement:_build_panel( panel, panel_sizer )
	...
	alternative:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = alternative, value = "alternative" } )
	alternative:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = alternative, value = "alternative" } )
