...
function SpawnEnemyGroupUnitElement:_build_panel( panel, panel_sizer )	
	...
	local ignore_disabled = EWS:CheckBox( panel, "Ignore disabled", "" )
		...
		ignore_disabled:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = ignore_disabled, value = "ignore_disabled" } )
	...
	--print( "[SpawnEnemyGroupUnitElement:_build_panel] opt", inspect( opt ) )
...
function SpawnEnemyGroupUnitElement:on_preferred_spawn_groups_checkbox_changed( params )
	--print( "[SpawnEnemyGroupUnitElement:on_preferred_spawn_groups_checkbox_changed] preferred_spawn_groups", inspect( self._hed.preferred_spawn_groups ), "name", params.name, "value", params.ctrlr:get_value() )
