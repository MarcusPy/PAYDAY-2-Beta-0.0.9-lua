...
function WaypointUnitElement:init( unit )	
	...
	self._icon_options = { "pd2_lootdrop", "pd2_escape", "pd2_talk", "pd2_kill", "pd2_drill", "pd2_generic_look", "pd2_phone", "pd2_c4", "pd2_power", "pd2_door", "pd2_computer", "pd2_wirecutter", "pd2_fire", "pd2_loot", "pd2_methlab", "pd2_generic_interact", "pd2_goto", "wp_vial", "wp_standard", "wp_powersupply", "wp_watersupply", "wp_c4", "wp_drill", "wp_hack", "wp_talk", "wp_crowbar", "wp_planks", "wp_door", "wp_saw", "wp_bag", "wp_exit", "wp_can", "wp_target", "wp_key", "wp_winch", "wp_escort", "wp_powerbutton", "wp_server", "wp_powercord", "wp_phone", "wp_scrubs", "wp_sentry" }
