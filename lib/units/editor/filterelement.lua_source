...
function FilterUnitElement:_build_panel( panel, panel_sizer )	
	...
	difficulty_easy:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = difficulty_easy, value = "difficulty_easy" } )
	...
	difficulty_normal:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = difficulty_normal, value = "difficulty_normal" } )
	...
	difficulty_hard:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = difficulty_hard, value = "difficulty_hard" } )
	...
	difficulty_overkill:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = difficulty_overkill, value = "difficulty_overkill" } )
	...
	difficulty_overkill_145:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = difficulty_overkill_145, value = "difficulty_overkill_145" } )
	...
	platform_win32:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = platform_win32, value = "platform_win32" } )
	...
	platform_ps3:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = platform_ps3, value = "platform_ps3" } )
	...
	mode_control:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = mode_control, value = "mode_control" } )
	...
	mode_assault:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = mode_assault, value = "mode_assault" } )
