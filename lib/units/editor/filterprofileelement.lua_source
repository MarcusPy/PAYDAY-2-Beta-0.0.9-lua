...
function FilterProfileUnitElement:_build_panel( panel, panel_sizer )	
	...
	money_earned:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = money_earned, value = "money_earned" } )
	money_earned:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = money_earned, value = "money_earned" } )
	...
	money_offshore:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = money_offshore, value = "money_offshore" } )
	money_offshore:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = money_offshore, value = "money_offshore" } )
	...
	achievement:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = achievement, value = "achievement" } )
end
