...
function AiGlobalEventUnitElement:init( unit )
	...
	self._wave_modes = { "none", "assault", "besiege", "blockade", "hunt", "quiet", "passive" }
	self._AI_events = { "none", "police_called", "police_weapons_hot", "gangsters_called", "gangster_weapons_hot" }
	self._blames = { "none", "empty", "cop", "gangster", "civilian", "metal_detector", "security_camera", "civilian_alarm", "cop_alarm", "gangster_alarm", "motion_sensor" }
	
	--self._hed.wave_mode = nil
	--self._hed.AI_event = nil
...
function AiGlobalEventUnitElement:post_init()
	if self._hed.event then -- backwards compatibility
