...
function CopInventory:init( unit )
	...
	self._align_places.back = { obj3d_name = Idstring("Hips"), on_body = true }
...
function CopInventory:anim_clbk_weapon_attached( unit, state )
	...
	if location == true then
		...
		--print( "linking", res, parent_unit, align_place.obj3d_name, weap_unit, weap_unit:orientation_object():name() )
	else
		print( "unlinking" )
