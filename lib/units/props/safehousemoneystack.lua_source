...
function SafehouseMoneyStack:init( unit )
	...
	local sequence = (sequence_index == 0) and "var_money_grow_00" 
						or self._sequences[ math.clamp( sequence_index, 1, #self._sequences ) ]

	-- print( "run sequence", sequence_index, sequence )
