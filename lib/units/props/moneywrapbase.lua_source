...
function MoneyWrapBase:sync_money_taken() -- amount )
	if self.give_exp then
		...
		local amount = self.money_action and tweak_data.money_manager.actions[ self.money_action ] or self._MONEY_MAX/2 -- tweak_data.money_manager.actions[ self.money_action or "money_wrap" ]
...
function MoneyWrapBase:_take_money( unit )
	local took = self.money_action and tweak_data.money_manager.actions[ self.money_action ] or self._MONEY_MAX/2 -- tweak_data.money_manager.actions[ self.money_action or "money_wrap" ]
