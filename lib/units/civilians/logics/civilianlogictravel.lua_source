...
function CivilianLogicTravel.enter( data, new_logic_name, enter_params )
	...
	--print( "[CivilianLogicTravel.enter]" )
...
function CivilianLogicTravel.update( data )
	...
	elseif my_data.advance_path then
		...
		CopLogicAttack._correct_path_start_pos( data, my_data.advance_path )	-- makes sure the first nav point is our current position
...
function CivilianLogicTravel.on_intimidated( data, amount, aggressor_unit )
	...
	local new_objective = { type = "surrender", amount = amount, aggressor_unit = aggressor_unit }
