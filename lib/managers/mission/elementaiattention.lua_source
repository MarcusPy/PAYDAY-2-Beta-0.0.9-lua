...
function ElementAIAttention:on_executed( instigator )
	...
	elseif self._values.att_obj_u_id then
		--local unit = managers.editor:unit_with_id( self._values.att_obj_u_id )
		local unit = self:_fetch_unit_by_unit_id( self._values.att_obj_u_id )
		--print( "[ElementAIAttention:on_executed] self._values.att_obj_u_id", self._values.att_obj_u_id, "unit", unit ) 
		if unit then
...
function ElementAIAttention:_apply_attention_on_unit( unit, handler )
	--print( "[ElementAIAttention:_apply_attention_on_unit]", self._values.operation, unit, handler )
...
function ElementAIAttention:_chk_link_att_object( unit, handler )
	...
	--local parent_unit = managers.editor:unit_with_id( self._values.parent_u_id )
