...
function PlayerManager:spawn_dropin_penalty( dead, bleed_out, health, used_deployable )
	...
	--[[	
	elseif bleed_out then
		print( "[ConnectionNetworkHandler:spawn_dead] Trippin'" )
...
function PlayerManager:_add_equipment( params )
	...
	table.insert( self._equipment.selections, { equipment = equipment, amount = 0, use_function = use_function, action_timer = tweak_data.action_timer } )
...
--	print( "ADD IT", name )
	...
	self._equipment.specials[ name ] = { --[[hud_id = hud_id,]] amount = quantity or nil, is_cable_tie = is_cable_tie }
