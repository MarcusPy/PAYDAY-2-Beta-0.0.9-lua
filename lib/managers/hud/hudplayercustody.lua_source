...
function HUDPlayerCustody:init( hud )
	...
	local custody_panel = self._hud_panel:panel( { name = "custody_panel", halign="grow", valign="grow" } )
	-- custody_panel:set_debug( true )
    ...
    local civilians_killed = custody_panel:text( { name = "civilians_killed", text = "Civilians killed", align = "right", vertical = "top", valign="bottom", w = 400, h = 32, font = tweak_data.hud_custody.custody_font, font_size = tweak_data.hud_custody.small_font_size } )
    local trade_delay = custody_panel:text( { name = "trade_delay", text = "Trade delay", align = "right", vertical = "top", valign="bottom", w = 400, h = 32, font = tweak_data.hud_custody.custody_font, font_size = tweak_data.hud_custody.small_font_size } )
		
	self._hud_panel:script().text_title = self._hud_panel:child( "text_title" ) or self._hud_panel:text( { name="text_title", color=Color.white, font_size=28, font="fonts/font_medium_shadow_mf", text="", align="right", vertical="top", h="32" } )
	self._hud_panel:script().text_next_player = self._hud_panel:child( "text_next_player" ) or self._hud_panel:text( { name="text_next_player", color=Color.white, font_size=28, font="fonts/font_medium_shadow_mf", text="", align="right", vertical="top", h="32" } )
