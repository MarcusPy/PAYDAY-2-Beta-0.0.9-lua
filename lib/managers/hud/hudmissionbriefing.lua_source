...
function HUDMissionBriefing:init( hud, workspace )
	...
	for i = 1, 10 do
		...
		self._paygrade_panel:bitmap( { texture="guis/textures/pd2/mission_briefing/difficulty_icons", texture_rect=filled_star_rect, x=x, y=y, w=16, h=16, alpha=1, color=color, alpha=alpha } )
		x = x + star_size
