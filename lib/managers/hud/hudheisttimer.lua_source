...
function HUDHeistTimer:init( hud )
	...
	self._heist_timer_panel = self._hud_panel:panel( { visible = true, name = "heist_timer_panel", h = 40, y = 0, valign = "top", layer = 0 } )
			
	self._timer_text = self._heist_timer_panel:text( { name = "timer_text", text = "00:00", font_size = 28, font = tweak_data.hud.medium_font_noshadow, color = Color.white, align = "center", vertical = "top", layer = 1, wrap = false, word_wrap = false } )
...
--[[function HUDHeistTimer:_animate_show()
