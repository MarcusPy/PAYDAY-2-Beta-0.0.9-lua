...
function HUDHitConfirm:init( hud )
	...
	self._hit_confirm = self._hud_panel:bitmap( { valign="center", halign="center", visible = false, name = "hit_confirm", texture = "guis/textures/pd2/hitconfirm", color = Color.white, layer = 0, blend_mode="add" } )
