		...
		if alive( data.unit ) then
			if data.type == "sniper" then 
				...
				if data.timer > data.next_shot then
					local warning_time = 4				-- After this amount of seconds, shots will be more frequent and more chance of damage
					data.next_shot = data.timer + math.rand( data.timer > warning_time and 0.5 or 1 )
