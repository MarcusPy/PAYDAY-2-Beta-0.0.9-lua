...
function MenuManager:toggle_chatinput()
	...
	if not MenuCallbackHandler:is_pc_controller() then --SystemInfo:platform() ~= Idstring( "WIN32" ) then
		return
	end
...
--overlay_name: "Friends", "Community", "Players", "Settings", "LobbyInvite", "OfficialGameGroup", "Stats", "Achievements".
end
...
function MenuCallbackHandler:give_max_experience()
	managers.experience:debug_add_points( 2500 * 144, false )
end
