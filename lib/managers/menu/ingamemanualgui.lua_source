...
function IngameManualGui:init( ws, fullscreen_ws )
	...
	-- local polyline = self._manual_panel:polyline( { layer=4, points={ Vector3(0, height, 0), Vector3(width, height, 0), Vector3(width, self._manual_panel:h()-height, 0), Vector3(0, self._manual_panel:h()-height, 0) }, closed=true, rotation=360 } )
