...
function MenuNodeTableGui:_create_menu_item( row_item )
	...
	elseif row_item.type == "server_column" then
		...
		row_item.heist_name = row_item.gui_info_panel:text( { visible = false, text = string.upper( row_item.item:parameters().level_name ), layer = self.layers.items, font = self.font, font_size = tweak_data.menu.challenges_font_size, color = row_item.color, align = "left", vertical = "left" } )
		...
		-- row_item.server_state_topic = row_item.gui_info_panel:text( { text = string.upper( managers.localization:text( "menu_lobby_server_state_title" ) ), layer = self.layers.items, font = self.font, font_size = tweak_data.menu.challenges_font_size, color = row_item.color, align = "left", vertical = "left" } )
		
		local font_size = tweak_data.menu.lobby_info_font_size
		
		row_item.server_title = row_item.gui_info_panel:text( { name = "server_title", text = string.upper( managers.localization:text( "menu_lobby_server_title" ) ), font = tweak_data.menu.default_font, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
		row_item.server_text = row_item.gui_info_panel:text( { name = "server_text", text = string.upper( row_item.item:parameters().host_name ), font = tweak_data.menu.default_font, color = tweak_data.hud.prime_color, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
		
		row_item.server_info_title = row_item.gui_info_panel:text( { name = "server_info_title", text = string.upper( managers.localization:text( "menu_lobby_server_state_title" ) ), font = self.font, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
		row_item.server_info_text = row_item.gui_info_panel:text( { name = "server_info_text", text = string.upper( row_item.item:parameters().state_name ), font = self.font, color = tweak_data.hud.prime_color, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
		
		row_item.level_title = row_item.gui_info_panel:text( { name = "level_title", text = string.upper( managers.localization:text( "menu_lobby_campaign_title" ) ), font = tweak_data.menu.default_font, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
		row_item.level_text = row_item.gui_info_panel:text( { name = "level_text", text = string.upper( row_item.item:parameters().real_level_name ), font = tweak_data.menu.default_font, color = tweak_data.hud.prime_color, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )

		row_item.difficulty_title = row_item.gui_info_panel:text( { name = "difficulty_title", text = string.upper( managers.localization:text( "menu_lobby_difficulty_title" ) ), font = tweak_data.menu.default_font, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )	
		row_item.difficulty_text = row_item.gui_info_panel:text( { name = "difficulty_text", text = string.upper( managers.localization:text( "menu_difficulty_"..row_item.item:parameters().difficulty ) ), font = tweak_data.menu.default_font, color = tweak_data.hud.prime_color, font_size = font_size, align = "left", vertical = "center", w = 256, h = font_size, layer = 1} )
