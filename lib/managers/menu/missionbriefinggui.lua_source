...
function AssetsItem:create_assets( assets_names, max_assets )
	...
	if rect then
		self._asset_text = self._panel:text( { name="asset_text", text="", h=32+32, align="center", vertical="top", font_size=tweak_data.menu.pd2_small_font_size, font=tweak_data.menu.pd2_small_font, layer=2, color=tweak_data.screen_colors.text } )
	...
	if #self._assets_list > 6 then
		...
		self._move_left_rect = self._panel:bitmap( { texture="guis/textures/pd2/hud_arrow", color=tweak_data.screen_colors.button_stage_3, rotation=360, w=32, h=32, blend_mode="add" } )
		...
		self._move_right_rect = self._panel:bitmap( { texture="guis/textures/pd2/hud_arrow", color=tweak_data.screen_colors.button_stage_3, rotation=180, w=32, h=32, blend_mode="add" } )
