...
function MenuItemMultiChoice:reload( row_item, node )
	...
	row_item.arrow_left:set_color( self:left_arrow_visible() and tweak_data.screen_color_blue or tweak_data.screen_color_blue:with_alpha(0.5) ) -- tweak_data.menu.arrow_available or tweak_data.menu.arrow_unavailable )
	row_item.arrow_right:set_color( self:right_arrow_visible() and tweak_data.screen_color_blue or tweak_data.screen_color_blue:with_alpha(0.5) ) -- tweak_data.menu.arrow_available or tweak_data.menu.arrow_unavailable )
