--	Documentation: http://ganonbackup/wiki_artistwiki/index.php/DialogManager
...
GenericSystemMenuManager.DIALOG_CLASS = GenericDialog			-- Dialog to show when a platform dependent dialog is shown.
GenericSystemMenuManager.GENERIC_DIALOG_CLASS = GenericDialog	-- Dialog to show when a platform independent dialog is shown.
...
GenericSystemMenuManager.SELECT_STORAGE_DIALOG_CLASS = nil			-- Dialog to show when a platform dependent select storage dialog is shown.
GenericSystemMenuManager.GENERIC_SELECT_STORAGE_DIALOG_CLASS = nil	-- Dialog to show when a platform independent select storage dialog is shown.
GenericSystemMenuManager.DELETE_FILE_DIALOG_CLASS = nil				-- Dialog to show when a platform dependent delete file dialog is shown.
GenericSystemMenuManager.GENERIC_DELETE_FILE_DIALOG_CLASS = nil		-- Dialog to show when a platform independent delete file dialog is shown.
GenericSystemMenuManager.KEYBOARD_INPUT_DIALOG = nil				-- Dialog to show when a platform dependent keyboard input dialog is shown.
GenericSystemMenuManager.GENERIC_KEYBOARD_INPUT_DIALOG = nil		-- Dialog to show when a platform independent keyboard input dialog is shown.
GenericSystemMenuManager.GENERIC_SELECT_USER_DIALOG = nil			-- Dialog to show when a platform dependent select user dialog is shown.
GenericSystemMenuManager.SELECT_USER_DIALOG = nil					-- Dialog to show when a platform independent select user dialog is shown.
GenericSystemMenuManager.GENERIC_ACHIEVEMENTS_DIALOG = nil			-- Dialog to show when a platform dependent achievements dialog is shown.
GenericSystemMenuManager.ACHIEVEMENTS_DIALOG = nil					-- Dialog to show when a platform independent achievements dialog is shown.
GenericSystemMenuManager.GENERIC_FRIENDS_DIALOG = nil				-- Dialog to show when a platform dependent friends dialog is shown.
GenericSystemMenuManager.FRIENDS_DIALOG = nil						-- Dialog to show when a platform independent friends dialog is shown.
GenericSystemMenuManager.GENERIC_PLAYER_REVIEW_DIALOG = nil			-- Dialog to show when a platform dependent player review dialog is shown.
GenericSystemMenuManager.PLAYER_REVIEW_DIALOG = nil					-- Dialog to show when a platform independent player review dialog is shown.
GenericSystemMenuManager.GENERIC_PLAYER_DIALOG = nil				-- Dialog to show when a platform dependent player dialog is shown.
GenericSystemMenuManager.PLAYER_DIALOG = nil						-- Dialog to show when a platform independent player dialog is shown.
GenericSystemMenuManager.GENERIC_MARKETPLACE_DIALOG = nil			-- Dialog to show when a platform dependent marketplace dialog is shown.
GenericSystemMenuManager.MARKETPLACE_DIALOG = nil					-- Dialog to show when a platform independent marketplace dialog is shown.
]]
...
function GenericSystemMenuManager:init()
	...
	self._active_dialog = nil
	self._is_ws_visible = nil
	self._old_active_state = nil
	]]
end
...
function GenericSystemMenuManager:init_finalize()
	...
	if( Global.dialog_manager.init_show_data_list ) then -- and not managers.exec:will_execute() ) then
...
function GenericSystemMenuManager:force_close_all()
	-- print( self._active_dialog and inspect( self._active_dialog._data ), self._active_dialog and self._active_dialog:blocks_exec() )
	if self._active_dialog and self._active_dialog:blocks_exec() then
		-- print( "GenericSystemMenuManager:force_close_all()" )
...
function GenericSystemMenuManager:close( id )
	...
	-- print( inspect( self._dialog_queue ) )
...
-- Replace this with a engine function:
...
function GenericSystemMenuManager:event_active_changed( active )
	...
	-- managers.timer:set_paused( active )
...
-- PS3SystemMenuManager.DIALOG_CLASS = PS3Dialog
