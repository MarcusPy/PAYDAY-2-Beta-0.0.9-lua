...
function StatisticsManager:publish_to_steam( session, success )
	...
	for weapon, data in pairs( session.shots_by_weapon ) do
		if data.total > 0 then
			...
			stats[ weapon .. "_kills" ] = { type = "int", value = session.killed_by_weapon[ weapon ] and session.killed_by_weapon[ weapon ].count or 0 }
			stats[ weapon .. "_headshots" ] = { type = "int", value = session.killed_by_weapon[ weapon ] and session.killed_by_weapon[ weapon ].headshots or 0 }
		end
	end

	for unit, data in pairs( session.killed ) do
		if not (unit == "civilian" or unit == "civilian_female" or unit == "other" or unit == "total") then
	...
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "wins" ] = { type = "int", value = success and 1 or 0 }

	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "shots" ] = { type = "int", value = session.shots_fired.total }
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "shots_per_minute" ] = { type = "avgrate", value = session.shots_fired.total / session_time_minutes, hours = session_time }
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "kills" ] = { type = "int", value = session.killed.total.count }
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "kills_per_minute" ] = { type = "avgrate", value = session.killed.total.count / session_time_minutes, hours = session_time }

	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "accuracy" ] = { type = "avgrate", value = session.shots_fired.total > 0 and (session.shots_fired.hits / session.shots_fired.total) * 100 or 0, hours = session_time }

	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "health_lost" ] = { type = "int", value = session.health.amount_lost }
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "health_lost_per_minute" ] = { type = "avgrate", value = session.health.amount_lost / session_time_minutes, hours = session_time }
	...
	if success and not managers.statistics:is_dropin() then
  	...
  	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "custody" ] = { type = "int", value = session.misc.in_custody or 0 }
	stats[ Global.game_settings.difficulty .. "_" .. Global.level_data.level_id .. "_" .. "cash" ] = { type = "int", value = session.misc.cash or 0 }
	...
	stats[ "total_accuracy" ] = { type = "avgrate", value = session.shots_fired.total > 0 and (session.shots_fired.hits / session.shots_fired.total) * 100 or 0, hours = session_time }
	stats[ "allies_revived" ] = { type = "int", value = session.revives.npc_count + session.revives.player_count }
	
	
	stats[ "allies_traded" ] = 		{ type = "int", value = session.misc.trade or 0 }
	stats[ "deployed_medic" ] = 	{ type = "int", value = session.misc.deploy_medic or 0 }
	stats[ "deployed_ammo" ] = 		{ type = "int", value = session.misc.deploy_ammo or 0 }
	stats[ "deployed_trip_mine" ] = { type = "int", value = session.misc.deploy_trip or 0 }
	stats[ "deployed_ecm_jammer" ] = { type = "int", value = session.misc.deploy_jammer or 0 }
