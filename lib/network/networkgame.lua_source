		...
		if Network:multiplayer() then
			...
			elseif Network:is_server() then
				...
				if player_left then
					...
					self._old_players[ peer_ident ] = { t = Application:time(), member_downed = member_downed, health = member_health, used_deployable = member_used_deployable, member_dead = member_dead }
