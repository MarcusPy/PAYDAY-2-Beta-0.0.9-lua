...
HuskServerSyncedCivilianDamage._RESULT_NAME_TABLE = { "hurt", "light_hurt", "heavy_hurt", "death" }
...
function HuskServerSyncedCivilianDamage:_clamp_health_percentage( health_abs )
	local damage = math.clamp( health_abs, self._HEALTH_INIT_PRECENT, self._HEALTH_INIT ) -- Cannot give less than 1% damage
