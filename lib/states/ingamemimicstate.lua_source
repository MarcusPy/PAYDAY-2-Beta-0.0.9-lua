...
function IngameMimicInteractionState:init( game_state_machine )
	...
	self._text = self._panel:text{ name="text", text="Mimic", font="fonts/font_fortress_22", font_size = 24, color=Color.white, layer=1 }
	self._text = self._panel:text{ name="text", text="Mimic", font="fonts/font_fortress_22", font_size = 24, color=Color.black, layer=0, x=-2, y=-2 }
	self._text = self._panel:text{ name="text", text="Mimic", font="fonts/font_fortress_22", font_size = 24, color=Color.black, layer=0, x=2, y=-2 }
	self._text = self._panel:text{ name="text", text="Mimic", font="fonts/font_fortress_22", font_size = 24, color=Color.black, layer=0, x=2, y=2 }
	self._text = self._panel:text{ name="text", text="Mimic", font="fonts/font_fortress_22", font_size = 24, color=Color.black, layer=0, x=-2, y=2 }
	self._ws:hide()
