...
function WeaponTweakData:_init_data_m14_sniper_npc()
	...
	self.m14_sniper_npc.DAMAGE = 5.5				-- This gets multiplied with the dmg_mul value in character tweak data
...
-- Alert size				uses suppression index for value ( weapons and weapon parts )
	...
	self.stats.alert_size				= { 30000, 20000, 15000, 10000, 7500, 6000, 4500, 4000, 3500,  1800, 1500, 1200, 1000, 900, 800, 700, 600, 500, 400, 200 } -- added so the gameplay doesnt break to much from mantis issue #0009879
...
function WeaponTweakData:_init_new_weapons( autohit_rifle_default, autohit_pistol_default, autohit_shotgun_default, damage_melee_default, damage_melee_effect_multiplier_default, aim_assist_rifle_default, aim_assist_pistol_default, aim_assist_shotgun_default )
	...
	self.olympic.timers = {}
	self.olympic.timers.reload_not_empty = 2.3 -- 1.6 
	self.olympic.timers.reload_empty = 2.4 -- 2.2
	...
	self.ak74.timers = {}
	self.ak74.timers.reload_not_empty = 1.97 -- 1.6 
	self.ak74.timers.reload_empty = 3.1 -- 2.2
	...
	self.akm.timers = {}
	self.akm.timers.reload_not_empty = 1.97 -- 1.6 
	...
	self.akmsu.timers = {}
	self.akmsu.timers.reload_not_empty = 1.97 -- 1.6 
	self.akmsu.timers.reload_empty = 3.1 -- 2.2
	...
	self.saiga.timers = {}
	self.saiga.timers.reload_not_empty = 1.97 -- 1.6 
	self.saiga.timers.reload_empty = 3.1 -- 2.2
