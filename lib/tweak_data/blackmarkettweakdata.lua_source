...
function BlackMarketTweakData:_init_weapon_mods( tweak_data )
	...
	for id, data in pairs( tweak_data.weapon.factory.parts ) do
		self.weapon_mods[ id ] = { pc = data.pc, pcs = data.pcs, name_id = data.name_id, desc_id = data.desc_id, infamous = data.infamous, value = data.stats and data.stats.value or 1 }	
	end
...
function BlackMarketTweakData:_init_textures()
	...
	-- self.textures.fan.pc = 70 -- self.colors.red_black.pc = 40 -- Made unique for preorder
...
function BlackMarketTweakData:_init_armors()
	...
	self.armors.level_1.concealment = 10			-- concealment index, higher is better
	...
	self.armors.level_2.concealment = 9				-- concealment index, higher is better
	...
	self.armors.level_3.concealment = 6				-- concealment index, higher is better
	self.armors.level_3.movement_penalty = 3 		-- Movement penalty upgrade table
	
	self.armors.level_4 = {}
	self.armors.level_4.name_id = "bm_armor_level_4"
	self.armors.level_4.sequence = "var_model_04"
	self.armors.level_4.upgrade_level = 3
	self.armors.level_4.concealment = 5				-- concealment index, higher is better
	self.armors.level_4.movement_penalty = 4 		-- Movement penalty upgrade table
	
	self.armors.level_5 = {}
	self.armors.level_5.name_id = "bm_armor_level_5"
	self.armors.level_5.sequence = "var_model_05"
	self.armors.level_5.upgrade_level = 4
	self.armors.level_5.concealment = 1				-- concealment index, higher is better
	self.armors.level_5.movement_penalty = 5 		-- Movement penalty upgrade table
	
	self.armors.level_6 = {}
	self.armors.level_6.name_id = "bm_armor_level_6"
	self.armors.level_6.sequence = "var_model_06"
	self.armors.level_6.upgrade_level = 5
	self.armors.level_6.concealment = 1				-- concealment index, higher is better
	self.armors.level_6.movement_penalty = 6 		-- Movement penalty upgrade table
