...
function EquipmentsTweakData:init()
	...
	self.trip_mine 	= {
						...
						deploy_time			= 2,
						upgrade_deploy_time_multiplier = { category = "player", upgrade = "trip_mine_deploy_time_multiplier" },
	...
	self.sentry_gun 	= {
						...
						deploy_time			= 2,
						upgrade_deploy_time_multiplier = { category = "player", upgrade = "sentry_gun_deploy_time_multiplier" },
	...
	self.specials.cable_tie 		= {
										...
										-- max_amount = 2,
										quantity = 2,
										-- extra_upgrade = "extra_cable_tie",
										extra_quantity = {	equipped_upgrade 	= "extra_cable_tie", 
	...
	self.specials.bank_manager_key 	= {
										...
										-- dialog_id = "Play_1wb_rb3_07x_any",
	...
	self.specials.chavez_key 	= {
										...
										-- dialog_id = "Play_apa_rb3_02x_any",
										sync_possession = true
										}							
