...
function ChallengesTweakData:init()
	if true then -- Disable all challenges
		return
	end
	...
	--[[self.character.combine_test = {
								flag_id = "combine_test",
								counter_id = "kill",
								count = 2,
								unlock_level = 6,
								xp = huge_xp
	...
	self.character.reset_test = {
								counter_id = "kill",
								count = 10,
								unlock_level = 1,
								xp = huge_xp,
								reset_criterias = { "session", "bleed_out" },
								-- value = 600,
								-- compare = ""
								}]]
...
--[[
	self.achievment.akimbo = {
								title_id = "ch_akimbo_hl",
								description_id = "ch_akimbo",
								flag_id = "akimbo",
								unlock_level = 0,
								xp = tiny_xp,
								awards_achievment = "akimbo"
								}								
]]								
...
--[[								
	self.achievment.meat_packing = {
								title_id = "ch_meat_packing_hl",
								description_id = "ch_meat_packing",
								flag_id = "meat_packing",
								unlock_level = 0,
								xp = huge_xp,
								awards_achievment = "meat_packing"
								}
]]								
...
--[[
	self.achievment.citys_finest = {
								title_id = "ch_citys_finest_hl",
								description_id = "ch_citys_finest",
								flag_id = "citys_finest",
								unlock_level = 0,
								xp = gigantic_xp,
								awards_achievment = "citys_finest"
								}
]]
...
-- Session challenges
	...
	self.session.bank_no_civilians_hard = {			
										...
										level_id = "bank", difficulty = { "hard", "overkill", "overkill_145" },
	...
	self.session.bank_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "bank", difficulty = { "overkill", "overkill_145" },
	...
	self.session.bank_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										level_id = "bank", difficulty = "overkill_145",
	...
	self.session.street_no_civilians_hard = {			
										...
										unlock_level = 20, xp = mid_xp,
										level_id = "heat_street", difficulty = { "hard", "overkill", "overkill_145" },
										session_stopped = { callback = "no_civilians_killed" },
										}
	...
	self.session.street_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "heat_street", difficulty = { "overkill", "overkill_145" },
										session_stopped = { callback = "overkill_success" },
										}
	...
	self.session.street_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										increment_counter = "golden_boy",
										level_id = "heat_street", difficulty = "overkill_145",
										session_stopped = { callback = "overkill_success" },
	...
	self.session.bridge_no_civilians_hard = {			
										...
										unlock_level = 20, xp = mid_xp,
										level_id = "bridge", difficulty = { "hard", "overkill", "overkill_145" },
										session_stopped = { callback = "no_civilians_killed" },
										}
	...
	self.session.bridge_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "bridge", difficulty = { "overkill", "overkill_145" },
										session_stopped = { callback = "overkill_success" },
										}
	...
	self.session.bridge_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										increment_counter = "golden_boy",
										level_id = "bridge", difficulty = "overkill_145",
										session_stopped = { callback = "overkill_success" },
	...
	self.session.apartment_no_civilians_hard = {			
										...
										unlock_level = 20, xp = mid_xp,
										level_id = "apartment", difficulty = { "hard", "overkill", "overkill_145" },
										session_stopped = { callback = "no_civilians_killed" },
										}
	...
	self.session.apartment_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "apartment", difficulty = { "overkill", "overkill_145" },
										session_stopped = { callback = "overkill_success" },
										}
	...
	self.session.apartment_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										increment_counter = "golden_boy",
										level_id = "apartment", difficulty = "overkill_145",
										session_stopped = { callback = "overkill_success" },
	...
	self.session.slaughterhouse_no_civilians_hard = {			
										...
										unlock_level = 20, xp = mid_xp,
										level_id = "slaughter_house", difficulty = { "hard", "overkill", "overkill_145" },
										session_stopped = { callback = "no_civilians_killed" },
										}
	...
	self.session.slaughterhouse_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "slaughter_house", difficulty = { "overkill", "overkill_145" },
										session_stopped = { callback = "overkill_success" },
										}
	...
	self.session.slaughterhouse_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										increment_counter = "golden_boy",
										level_id = "slaughter_house", difficulty = "overkill_145",
										session_stopped = { callback = "overkill_success" },
	...
	self.session.diamond_heist_no_civilians_hard = {			
										...
										unlock_level = 20, xp = mid_xp,
										level_id = "diamond_heist", difficulty = { "hard", "overkill", "overkill_145" },
										session_stopped = { callback = "no_civilians_killed" },
										}
	...
	self.session.diamond_heist_success_overkill = {
										...
										unlock_level = 48, xp = gigantic_xp,
										level_id = "diamond_heist", difficulty = { "overkill", "overkill_145" },
										session_stopped = { callback = "overkill_success" },
										}
	...
	self.session.diamond_heist_success_overkill_145 = {
										...
										unlock_level = 145, xp = gigantic_xp,
										increment_counter = "golden_boy",
										level_id = "diamond_heist", difficulty = "overkill_145",
										session_stopped = { callback = "overkill_success" },
	...
	if managers.dlc:has_dlc2() then
		...
		self.session.suburbia_no_civilians_hard = {			
											...
											unlock_level = 20, xp = mid_xp,
											level_id = "suburbia", difficulty = { "hard", "overkill", "overkill_145" },
											session_stopped = { callback = "no_civilians_killed" },
											}
		...
		self.session.suburbia_success_overkill = {
											...
											unlock_level = 48, xp = gigantic_xp,
											level_id = "suburbia", difficulty = { "overkill", "overkill_145" },
											session_stopped = { callback = "overkill_success" },
											}
		...
		self.session.suburbia_success_overkill_145 = {
											...
											unlock_level = 145, xp = gigantic_xp,
										--	increment_counter = "golden_boy",
											level_id = "suburbia", difficulty = "overkill_145",
											session_stopped = { callback = "overkill_success" },
	...
	if managers.dlc:has_dlc3() then						
		...
		-- Secret stash
		--[[
		self.session.secret_stash_no_civilians_hard = {			
											title_id = "ch_secret_stash_no_civilians_hl",
											description_id = "ch_secret_stash_no_civilians",
											unlock_level = 20, xp = mid_xp,
											level_id = "secret_stash", difficulty = { "hard", "overkill", "overkill_145" },
											session_stopped = { callback = "no_civilians_killed" },
											}
		]]
		...
		self.session.secret_stash_success_overkill = {
											...
											unlock_level = 48, xp = gigantic_xp,
											level_id = "secret_stash", difficulty = { "overkill", "overkill_145" },
											session_stopped = { callback = "overkill_success" },
											}
		...
		self.session.secret_stash_success_overkill_145 = {
											...
											unlock_level = 145, xp = gigantic_xp,
										--	increment_counter = "golden_boy",
											level_id = "secret_stash", difficulty = "overkill_145",
											session_stopped = { callback = "overkill_success" },
...
function ChallengesTweakData:_any_weapon_challenges()
	local definition = {}
	definition.me = {}
	definition.me.vs_the_law = { 	{ count = 100, xp = tiny_xp, in_trial = true }, 
									{ count = 400, xp = small_xp },
									{ count = 800, xp = mid_xp },
								}
	definition.me.vs_the_law_head_shot = { 	{ count = 100, xp = tiny_xp }, 
...
function ChallengesTweakData:_c45_challenges()
	local definition = {}
	definition.c45 = {}
	definition.c45.vs_the_law = { 	{ count = 50, xp = tiny_xp }, 
	...
	definition.c45.head_shots = { 	{ count = 75, xp = small_xp }, 
									{ count = 200, xp = mid_xp },
...
function ChallengesTweakData:_ak47_challenges()
	...
	for i = 1, #definition.ak47.taser_kill do
		...
		local depends_on = { challenges = challenges, weapons = { "ak47" } }
		self.weapon[ name ] = { title_id = "ch_ak47_taser_kill_"..i.."_hl",
...
function ChallengesTweakData:_trip_mine_challenges()
	...
	definition.trip_mine.vs_the_law = { { count = 10, xp = tiny_xp }, 
...
function ChallengesTweakData:_bleed_out_challenges()
	...
	definition.bleed_out.vs_the_law = { { count = 10, xp = small_xp }, 
										{ count = 20, xp = small_xp },
										{ count = 40, xp = mid_xp }, 
										{ count = 80, xp = large_xp },
									}
...
function ChallengesTweakData:_melee_challenges()
	local definition = {}
	definition.melee = {}
	definition.melee.vs_the_law = { { count = 10, xp = tiny_xp, in_trial = true }, 
...
function ChallengesTweakData:_money_challenges()
	...
	definition.money.aquire = { 	{ amount =   20000, xp = mid_xp, in_trial = true }, 
									...
									{ amount = 1000000, xp = gigantic_xp, awards_achievment = "payday" },
								}
