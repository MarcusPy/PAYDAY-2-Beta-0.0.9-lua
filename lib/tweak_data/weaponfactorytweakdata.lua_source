...
function WeaponFactoryTweakData:_init_silencers()
	...
	self.parts.wpn_fps_upg_ns_ass_smg_large 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_upg_ns_ass_smg_large", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_large/wpn_fps_upg_ns_ass_smg_large",
																stats = { value = 5, suppression = 9, damage = -4, recoil = 3, spread_moving = -3, concealment = -3}, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" }
															}
	...
	self.parts.wpn_fps_upg_ns_ass_smg_medium 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_upg_ns_ass_smg_medium", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_medium/wpn_fps_upg_ns_ass_smg_medium",
																stats = { value = 2, suppression = 9, damage = -4, recoil = 1, spread_moving = -2, concealment = -2 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_b" }
															}
	...
	self.parts.wpn_fps_upg_ns_ass_smg_small 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id  = "bm_wp_upg_ns_ass_smg_small", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_small/wpn_fps_upg_ns_ass_smg_small",
																stats = { value = 3, suppression = 9, damage = -4, recoil = 0, spread_moving = -1, concealment = -1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_a" }
															}
	...
	self.parts.wpn_fps_upg_ns_pis_large 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_upg_ns_pis_large", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_large/wpn_fps_upg_ns_pis_large",
																stats = { value = 5, suppression = 9, damage = -4, recoil = 2, spread_moving = -2, concealment = -1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" }
															}
	...
	self.parts.wpn_fps_upg_ns_shot_thick 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_upg_ns_shot_thick", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_shot_thick/wpn_fps_upg_ns_shot_thick",
																stats = { value = 7, suppression = 9, damage = -4, recoil = 1, spread_moving = -2, concealment = -1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_a" }
															}
...
function WeaponFactoryTweakData:_init_sights()
	...
	-- Sight, Heavyweight, Best zoom, Big silhouette
	self.parts.wpn_fps_upg_o_aimpoint_2					= { type = "sight", name_id = "bm_wp_upg_o_aimpoint", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_aimpoint/wpn_fps_upg_o_aimpoint_preorder",
...
function WeaponFactoryTweakData:_init_m4()
	...
	self.parts.wpn_fps_upg_m4_m_pmag 						= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_m4_m_pmag", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_pmag",
																stats = { value = 3, spread_moving = 1, concealment = 0, extra_ammo = 6},
																-- animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	-- Mag, straight mag, 20
...
function WeaponFactoryTweakData:_init_amcar()
	-- Parts
	self.parts.wpn_fps_amcar_uupg_body_upperreciever = { type = "upper_reciever", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_amcar_pts/wpn_fps_amcar_uupg_body_upperreciever",
																	-- animations = { reload = "reload" },
...
function WeaponFactoryTweakData:_init_r870()
	...
	self.parts.wpn_fps_shot_r870_m_extended 				= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_r870_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_m_extended",
																stats = { value = 6, concealment = -1, spread_moving = -1, extra_ammo = 3 }
															}
