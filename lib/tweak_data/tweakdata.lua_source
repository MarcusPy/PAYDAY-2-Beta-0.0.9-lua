...
-- ExperienceManager
	...
	self.experience_manager.difficulty_multiplier = { 2, 4, 8 } -- This is an addition to the job/stage xp( stage_xp+stage_xp*mul ), hard, overkill, overkill_146
	...
	self.experience_manager.level_limit.pc_difference_multipliers = { 1, 0.9, 0.504, 0.3024, 0.1512, 0.06048, 0.018144, 0.0036288, 0.00036288, 0.0 }	-- players above low_cap_level will gain experience of the difference between his level and job level, from the different of pc
	
	
	self.experience_manager.civilians_killed					= 0		-- Amount of XP penalty recieved from each killed civilian during a heist
	
	self.experience_manager.day_multiplier = { 1, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6 }				-- multiplier on how much more experience you get for each day. mulitplied on base xp, day+job+risk
	self.experience_manager.pro_day_multiplier = { 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0 }	-- professional version, ( 7 days might be abit excessive )
